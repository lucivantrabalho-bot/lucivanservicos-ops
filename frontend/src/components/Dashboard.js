...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      {/* Header - Hidden on mobile since we use MobileNavigation */}
      <div className="hidden lg:block bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Gerenciador CN19</h1>
                <p className="text-sm text-slate-600 dark:text-gray-300">Bem-vindo, {user?.username}!</p>
              </div>
            </div>
